...
{
    internal class UnknownLayoutComplaint : Exception
    {
        public UnknownLayoutComplaint(string name, Dictionary<string, CustomLayout> layouts) : base(BuildMessage(name, layouts))
        {
